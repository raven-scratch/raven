...
///
/// `level` is the whole tune's loudness, and it is a tenth of what the synthesizer
/// would otherwise peak at: the music plays well under the effects, which are at full
